...
public class MainActivity extends AppCompatActivity {
    ...
    public void onResume()
    {
        ...
        Toast.makeText(this.getApplicationContext(), "onResume", Toast.LENGTH_SHORT);
        ...
        catch(PorcupineManagerException ex)
        {
            Toast.makeText(this.getApplicationContext(), "Error while init", Toast.LENGTH_SHORT);
        }
    }
